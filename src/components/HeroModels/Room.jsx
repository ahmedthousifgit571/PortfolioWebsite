...
export function Room(props) {
  const { nodes, materials } = useGLTF('/src/assets/public/models/optimized-room.glb');
  const screensRef = useRef();
  const matcapTexture = useTexture("src/assets/public/images/textures/mat1.png");
...
useGLTF.preload('/src/assets/public/models/optimized-room.glb');